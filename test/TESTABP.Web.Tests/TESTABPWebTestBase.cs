...
namespace TESTABP.Web.Tests {
    public abstract class TESTABPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup> {
        protected static readonly Lazy<string> ContentRootFolder;

        static TESTABPWebTestBase() {
            ContentRootFolder = new Lazy<string>(WebContentDirectoryFinder.CalculateContentRootFolder, true);
        }

        protected TESTABPWebTestBase() {
        ...
        protected void UsingDbContext(Action<TESTABPDbContext> action) {
        ...
        protected T UsingDbContext<T>(Func<TESTABPDbContext, T> func) {
            T result;
